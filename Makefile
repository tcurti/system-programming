...
OBJ=$(KERNEL_OBJ) gdt.o idt.o isr.o pic.o mmu.o screen.o tss.o game.o sched.o debug.o math.o player.o $(PRNG_OBJ)
...
TASKSCFLAGS=$(CFLAGS) -fno-toplevel-reorder -fno-omit-frame-pointer
